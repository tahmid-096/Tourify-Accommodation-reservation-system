...
if(isset($_POST['add_product'])){
   ...
   $address=filter_var ($address ,FILTER_SANITIZE_STRING );
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, details, price, image_01, image_02, image_03,category,p_person,p_bedroom,p_bed,p_bath,p_checkin,p_checkout,p_country,p_state,p_city,p_address,admin_id,p_status) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
      $insert_products->execute([$name, $details, $price, $image_01, $image_02, $image_03,$categoryOption,$person,$bedroom,$bed,$bath,$checkin,$checkout,$countryOption,$stateOption,$cityOption,$address,$admin_id,'not']);
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="id" >Place id: <?= $fetch_products['id']; ?></div>
